  ...
  <section>
    <div class="color-white mb-2">
      ...
      <p class="font-weight-light ps-4 pb-1 py-4 br-lg">
        <r-btn readonly size="small"> r-btn-group</r-btn>
        allows you to group a series of buttons together (on a single line) in a
        button group.
      </p>
    </div>
...
methods:{
 log(name,e){
  console.log(name,e)
        ...
        template='<r-btn-group :items="items" :icon="icon" :is-select="isSelect" :exact="exact" v-model="modelValue" @open="log(`open`,$event)" @update:model-Value="log(`update:modelValue`,$event)" ></r-btn-group>'
    ></r-code-editor>
  </section>
  <br/>
  <br/>
  <section class="pa-3 color-white">
    ...
    <section class="pa-4">
      <r-card class="px-5 py-8 card-hover">
        <r-btn-group
            :items="[1, 2, 3, 4, 5, 6, 7, 8, 9]"
            class="my-4 color-one"
        ></r-btn-group>
      </r-card>
    </section>
    <p class="caption">Press run Button</p>
  ...
  data() {
    return {
      props: [
        ...
        {prop: "icon", type: "Boolean", default: "true", description: "Icon"},
        {
          prop: "isSelect",
          type: "Boolean",
          default: "null",
          description: "Is Select",
        },
        {
          prop: "exact",
          type: "Boolean",
          default: "null",
          description: "Exactly match the link",
        },
        {
          prop: "modelValue",
          type: "Number,String",
