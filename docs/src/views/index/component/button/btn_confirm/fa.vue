<template>
  <section>
    <div class="color-white mb-2">
      ...
      <p class="font-weight-light ps-4 pb-1 py-4 br-lg">
        دکمه برای تایید فعالیت های که کاربر انجام می دهد .
      </p>
    </div>
  ...
  <section class="mt-10">
    ...
    <r-code-editor
        ...
        template='<r-btn-confirm :hard="hard" :title="title" :body="body" :cancel-text="cancelText" :confirm-text="confirmText" @click="log(`click`,$event)" >تایید</r-btn-confirm>'
    ></r-code-editor>
  </section>
  <br/>
  <br/>
  <section class="pa-3 color-white">
    <section class="pa-4">
      <r-card class="px-5 py-8 text-center card-hover">
        <r-btn-confirm class="color-warning">Start Confirm</r-btn-confirm>
      </r-card>
    </section>
    <p class="caption">Press run Button</p>
    <r-code-editor
...
export default {
  ...
  data() {
    return {
      props: [
        {prop: "hard", type: "Boolean", default: "null", description: "قوی "},
        {
          prop: "title",
          type: "String",
          default: "null",
        ...
        },
        {
          ...
          type: "String",
          default: "null",
          description: "بدنه btn",
        },
        {
          prop: "cancelText",
          type: "String",
          default: "null",
          description: "لغو کردن متن",
        },
        {
          prop: "confirmText",
          type: "String",
          default: "null",
          description: "متن تایید",
        },
      ],
  ...
  created() {
    this.$translate.add("confirm_code", "کد {0} را وارد کنید.");
  },
};
</script>
