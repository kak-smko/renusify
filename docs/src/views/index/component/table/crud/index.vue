...
<template>
  <section>
    <r-meta title="rTableCrud Component | Renusify" description="Document with example for Renusify rTableCrud component."></r-meta>
    <div class="mb-2">
      <h1 class="display-3 font-weight-light py-1 br-lg">
       rTableCrud Component
      </h1>
    </div>
...
const info={
  ...
  "props": [
    {
      "name": "link",
      "description": "API endpoint URL for data operations @type {String} @required",
      "type": "String",
      "default": "undefined"
    },
    {
      "name": "actions",
      "description": "Array of custom action buttons configuration @type {Array} @default () => []",
      "type": "Array",
      "default": "() => []"
    }
  ],
