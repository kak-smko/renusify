...
<template>
  <section>
    <r-meta title="rContainer Component | Renusify" description="Document with example for Renusify rContainer component."></r-meta>
    <div class="mb-2">
      <h1 class="display-3 font-weight-light py-1 br-lg">
       rContainer Component
      </h1>
    </div>
...
const info={
  ...
  "props": [
    {
      "name": "fullWidth",
      "description": "Makes container full width (fluid) @type {Boolean}",
      "type": "Boolean",
      "default": "undefined"
    },
    {
      "name": "fill",
      "description": "Makes container fill available height @type {Boolean}",
      "type": "Boolean",
      "default": "undefined"
    }
  ],
