...
<template>
  <section>
    <r-meta title="rSpacer Component | Renusify" description="Document with example for Renusify rSpacer component."></r-meta>
    <div class="mb-2">
...
const info={
  ...
  "slots": [
    {
      "name": "default",
      "description": "Default slot for spacer content"
    }
  ],
  "expose": [],
  "provide": []
