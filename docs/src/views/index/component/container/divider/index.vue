...
<template>
  <section>
    <r-meta title="rDivider Component | Renusify" description="Document with example for Renusify rDivider component."></r-meta>
    <div class="mb-2">
...
const info={
  ...
  "props": [
    {
      "name": "inset",
      "description": "Adds inset padding to the divider @type {Boolean}",
      "type": "Boolean",
      "default": "undefined"
    },
    {
      "name": "vertical",
      "description": "Makes the divider vertical instead of horizontal @type {Boolean}",
      "type": "Boolean",
      "default": "undefined"
    }
  ],
