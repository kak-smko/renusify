  ...
  <section>
    <div class="color-white mb-2">
      ...
      <p class="font-weight-light ps-4 pb-1 py-4 br-lg">
        <r-btn readonly size="small"> r-number-input</r-btn>
        It accepts numbers.
      </p>
    </div>
...
methods:{
 log(name,e){
  console.log(name,e)
        ...
        template='<r-number-input v-model="modelValue" :step="step" :split="split" :min="min" :max="max" :btn-Text="btnText" @update:model-Value="log(`update:modelValue`,$event)" ></r-number-input>'
    ></r-code-editor>
  </section>
  <br/>
  <br/>
  ...
  data() {
    return {
      ...
      props: [
        ...
        {prop: "split", type: "Number", default: "0", description: "Split"},
        {
          prop: "min",
          type: "Number",
          default: "undefined",
        ...
        },
        {
          ...
          type: "Boolean",
          default: "null",
          description: "The button simulates the table like text",
        },
      ],
