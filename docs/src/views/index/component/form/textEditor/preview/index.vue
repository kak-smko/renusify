...
<template>
  <section>
    <r-meta title="rTextEditorPreview Component | Renusify" description="Document with example for Renusify rTextEditorPreview component."></r-meta>
    <div class="mb-2">
      <h1 class="display-3 font-weight-light py-1 br-lg">
       rTextEditorPreview Component
      </h1>
    </div>
