  ...
  <section>
    <div class="color-white mb-2">
      ...
      <p class="font-weight-light ps-4 pb-1 py-4 br-lg">
        <r-btn readonly size="small"> r-text-area</r-btn>
        کنترل ورودی متن چند خطی است .
      </p>
    </div>
...
methods:{
 log(name,e){
  console.log(name,e)
        ...
        template='<r-text-area :no-Resize="noResize" v-model="modelValue" :rows="rows" @update:model-Value="log(`update:modelValue`,$event)" ></r-text-area>'
    ></r-code-editor>
  </section>
  <br/>
  <br/>
    ...
    return {
      ...
      props: [
        ...
        },
        {
          ...
          type: "String",
          default: "7",
          description: "ردیف ها را می تواند کم یا زیاد کرد",
        },
      ],
