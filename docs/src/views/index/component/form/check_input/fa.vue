  ...
  <section>
    <div class="color-white mb-2">
      ...
      <p class="font-weight-light ps-4 pb-1 py-4 br-lg">
        معتبر بودن کدهای تخفیف را مورد بررسی قرار می دهد .
      </p>
    </div>
...
methods:{
 log(name,e){
  console.log(name,e)
        ...
        template='<r-check-input :type="type" :name="name" :link="link" v-model="modelValue" :autofocus="autofocus" :headers="headers" @update:model-Value="log(`update:modelValue`,$event)" @data="log(`data`,$event)" ></r-check-input>'
    ></r-code-editor>
  </section>
  <br/>
  <br/>
    ...
    return {
      ...
      props: [
        ...
        },
        {
          ...
          default: "text",
          description:
              "نام را می توانید عوض کنید اما خودش بصورت پیشفرض txt است . ",
        },
        {
          prop: "link",
          type: "String",
          default: "null",
          description: "لینکی که برود بررسی را انجام بدهد",
        },
        {
          prop: "modelValue",
          type: "String,Number",
