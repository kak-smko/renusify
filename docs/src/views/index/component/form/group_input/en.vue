  ...
  <section>
    <div class="color-white mb-2">
      ...
      <p class="font-weight-light ps-4 pb-1 py-4 br-lg">
        Multiple tables are being added together simultaneously.
      </p>
    </div>
    ...
    return {
      ...
      props: [
        ...
        },
        {
          ...
          type: "Number",
          default: "null",
          description: "Restricting the size",
        },
        {
          prop: "disableAdd",
          type: "Boolean",
        ...
        },
        {
          ...
          type: "Boolean",
          default: "null",
          description: "To be translated or not",
        },
        {
          prop: "template",
          type: "Object",
        ...
        },
        {
          ...
          type: "String",
          default: "text-center",
          description: "Add it to the  Btn class",
        },
      ],
      events: [
